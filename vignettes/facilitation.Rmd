...
results <- community(maxtime=2,numstages=1,parameters=rates,dispersal=1,init=10)
```
...
param <- create.parameters(deathrates,growthrates,reproductionrate,radius) # create the parameter object
...
results <-
community(maxt,c(numstages,1),param,dispersalradius,init,interactionsD=effects,height=h,width=w)
```
...
results <-
community(maxt,nstages,param,dispersal,init,interactionsD=interactD,interactionsG=interactG)
```
...
results5 <- community(maxtime=maxt,numstages=3,parameters=rates,dispersal=10,init=c(40,0,0),
